...
contract('Event', (accounts) => {
    ...
    describe('Buy ticket from User', async () => {
        ...
        it('Set Ticket For Sale', async () => {
            //const ticketSaleStatusBefore = firstTicket.forSale
            await event.setTicketForSale(firstTicket.id, _resalePrice, { from: buyer1 });
            expect(firstTicket.forSale).to.be.eq(true);
