...
contract Event is ERC721 {
     ...
     * @param ticketID ticket ID of ticket
     */
    function buyTicketFromUser(uint ticketID) public payable requiredStage(Stages.Active) hasEnoughMoney(msg.value) returns (bool success) {
        ...
        transferFrom(seller, msg.sender, ticketID);
